          ...
          <div className='flex'>
            <div className=' relative w-[80%] mr-5 py-2 px-2 rounded-md border-2 border-gray-300 items-center'>
              <textarea 
                  ...
                  className={`${(rows === 6) ? "overflow-y-scroll" : "overflow-hidden"} w-[80%] h-auto ml-5 mb-5 overflow-scroll whitespace-pre-wrap border-none outline-none resize-none `}></textarea>
